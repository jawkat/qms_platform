...
class Domaine(db.Model, TimestampMixin):
...
class TexteReglementaire(db.Model, TimestampMixin):
    __tablename__ = 'texte_reglementaire'
...
class TexteVersion(db.Model, TimestampMixin):
    __tablename__ = 'texte_version'
